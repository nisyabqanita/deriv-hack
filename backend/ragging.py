...
load_dotenv()
voyager_key = os.getenv("VOYAGE_API_KEY")
if not voyager_key:
    raise ValueError(
        "API Key not found. Make sure you have set VOYAGE_API_KEY in your .env file."
    )
